            ...
            <section class="py-5 relative overflow-hidden bg-white">
                <div class="container mx-auto px-4 relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6">
                        ...
                        {{-- Case 1 --}}
                        <div class="md:col-span-7 block group relative overflow-hidden rounded-2xl bg-slate-900 min-h-[450px] transition-transform duration-300 hover:scale-[1.02]" data-aos="fade-up">
                            <div class="absolute inset-0 bg-cover bg-center md:grayscale group-hover:grayscale-0 scale-105 group-hover:scale-110 transition-all duration-1000 opacity-60"
                                style="background-image: url('https://images.unsplash.com/photo-1589578527966-fdac0f44566c?auto=format&fit=crop&w=1200&q=80');">
                            </div>
                            ...
                            <div class="relative h-full p-8 flex flex-col justify-end">
                                ...
                                <p class="text-slate-200 text-sm leading-relaxed mb-6">
                                    Successfully defended an employee against a <span class="text-[var(--accent)] font-bold">27-month delayed</span> rescission application. We convinced the Labour Court that excessive delays without valid explanations frustrate the ends of justice. The court dismissed the employer's attempt to stall, ordering the matter to proceed to trial immediately.
                                </p>
                                <div class="flex items-center gap-6 transition-all duration-500">
                        ...
                        {{-- Case 2 --}}
                        <div class="md:col-span-5 block group relative overflow-hidden rounded-2xl bg-slate-900 min-h-[450px] transition-transform duration-300 hover:scale-[1.02]" data-aos="fade-up">
                            <div class="absolute inset-0 bg-cover bg-center md:grayscale group-hover:grayscale-0 scale-105 group-hover:scale-110 transition-all duration-1000 opacity-60"
                                style="background-image: url('https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=80');">
                            </div>
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"></div>
                            <div class="relative h-full p-8 flex flex-col justify-end">
                                ...
                                <p class="text-slate-200 text-sm leading-relaxed mb-6">
                                    In a landmark case against <span class="text-[var(--accent)] font-bold">Umso Construction</span>, we successfully argued that economic necessity does not excuse a failure to follow fair retrenchment procedures. We secured <span class="text-[var(--accent)] font-bold">R122,000</span> in compensation and full legal costs for our client after proving a lack of meaningful consultation.
                                </p>
                                <div class="flex items-center gap-6 transition-all duration-500">
                        ...
                        {{-- Case 3 --}}
                        <div class="md:col-span-4 block group relative overflow-hidden rounded-2xl bg-slate-900 min-h-[450px] transition-transform duration-300 hover:scale-[1.02]" data-aos="fade-up">
                            <div class="absolute inset-0 bg-cover bg-center md:grayscale group-hover:grayscale-0 scale-105 group-hover:scale-110 transition-all duration-1000 opacity-60"
                        ...
                        <div class="md:col-span-4 block group relative overflow-hidden rounded-2xl bg-slate-900 min-h-[450px] transition-transform duration-300 hover:scale-[1.02]" data-aos="fade-up">
                            <div class="absolute inset-0 bg-cover bg-center md:grayscale group-hover:grayscale-0 scale-105 group-hover:scale-110 transition-all duration-1000 opacity-60"
                                style="background-image: url('https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&q=80');">
                            </div>
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"></div>
                            <div class="relative h-full p-8 flex flex-col justify-end">
                        ...
                        <div class="md:col-span-4 block group relative overflow-hidden rounded-2xl bg-slate-900 min-h-[450px] transition-transform duration-300 hover:scale-[1.02]" data-aos="fade-up">
                            <div class="absolute inset-0 bg-cover bg-center md:grayscale group-hover:grayscale-0 scale-105 group-hover:scale-110 transition-all duration-1000 opacity-60"
                                style="background-image: url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1200&q=80');">
                            </div>
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-transparent"></div>
                            <div class="relative h-full p-8 flex flex-col justify-end">
