...
@section('title', 'Expert Criminal Law Services | Sehunane Attorneys Inc')
@section('meta_description', 'Specialized criminal law representation in Kempton Park. We handle criminal defense, prosecutions, and legal proceedings with professional excellence.')
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-black mb-8">Criminal Law</h2>
                    <div class="space-y-6 text-gray-700 leading-relaxed text-base   ">
                        <p> Criminal law deals with offences committed against the state, including matters such as assault, 
                            theft, fraud, drug-related offences, bail applications, and other criminal charges. These matters 
                            can have serious consequences, including fines, a criminal record, or imprisonment.
                        </p>
                        <p>
                            At Sehunane Attorneys Inc, we understand that facing criminal charges can be overwhelming and 
                            frightening. Your freedom, reputation, and future may be at stake. Our role is to ensure that your 
                            rights are protected at every stage of the legal process and that you receive fair treatment under the law.
                        </p>
                        <p>
                            We provide strategic defence, thorough case preparation, and strong courtroom representation. 
                            From bail applications to trial proceedings, we are committed to safeguarding your rights and 
                    ...
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-lg font-bold text-black whitespace-nowrap">Our Criminal Law Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            @php
                                $Services = [
                                    'Bail applications',
                                    'Criminal defence in Magistrates’ and High Courts',
                    ...
                    <div class="mt-12 max-w-4xl" data-aos="fade-up" data-aos-delay="400">
                        <p class="text-gray-700 leading-relaxed text-base">
                            At <strong>Sehunane Attorneys Inc</strong>, we understand the seriousness of criminal proceedings and the impact they can have on your freedom and reputation. We provide strong legal defence, clear advice, and committed representation to ensure your rights are protected at every stage of the process.
                        </p>
                    </div>
                </div>
            </main>
