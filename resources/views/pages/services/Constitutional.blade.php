...
@section('title', 'Expert Constitutional Litigation Services | Sehunane Attorneys Inc')
@section('meta_description', 'Specialized constitutional litigation representation in Kempton Park. We handle human rights cases,
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-black mb-8">Constitutional Litigation</h2>
                    <div class="space-y-6 text-gray-700 leading-relaxed text-base">
                        <p>
                            Constitutional litigation involves matters that concern the interpretation, protection, and enforcement of constitutional rights. These cases may relate to equality, human rights, administrative justice, and the exercise of public power.
                        </p>
                        <p>
                            At <strong>Sehunane Attorneys Inc</strong>, we understand that constitutional matters often involve fundamental rights and principles that affect individuals and communities. These cases require careful legal analysis and a strong understanding of constitutional law.
                        </p>
                        <p>
                            We provide strategic advice and representation in matters where constitutional rights are at issue, ensuring that our clients’ rights are protected and upheld in accordance with the law.
                        </p>
                    </div>
                     {{-- Services Included Section --}}
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-xl font-bold text-black whitespace-nowrap">Our Constitutional Litigation Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            @php
                                $Services = [
                                    ...
                                    'Challenges to the validity of legislation or government action',
                    ...
                    <div class="mt-12 max-w-4xl" data-aos="fade-up" data-aos-delay="400">
                        <p class="text-gray-700 leading-relaxed text-base">
                            At <strong>Sehunane Attorneys Inc</strong>, we are committed to upholding and protecting the constitutional rights of our clients. Whether you are challenging the exercise of public power or seeking to enforce your fundamental rights, we provide clear guidance, strategic representation, and dedicated legal support to ensure your rights are fully protected under the law.
                        </p>
                    </div>
                </div>
            </main>
