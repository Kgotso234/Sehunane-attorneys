...
@section('title', 'Expert Civil Litigation Services | Sehunane Attorneys Inc')
@section('meta_description', 'Specialized civil litigation representation in Kempton Park. We handle contract disputes, personal injury claims, and civil lawsuits with professional excellence.')
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-black mb-8">Civil Litigation</h2>
                    <div class="space-y-6 text-gray-700 leading-relaxed text-base">
                        <p>
                            Civil litigation involves legal disputes between individuals, businesses, or entities where one party seeks compensation or enforcement of a right. These matters may include contractual disputes, damages claims, debt recovery, and other civil claims.
                        </p>
                        <p>
                            At <strong>Sehunane Attorneys Inc</strong>, we understand that legal disputes can disrupt both your personal and professional life. Prolonged conflict can be costly and stressful. Our approach focuses on resolving disputes efficiently while protecting your legal and financial interests.
                        </p>
                        <p>
                            We provide clear legal advice, careful case preparation, and effective representation in court or through alternative dispute resolution mechanisms.
                        </p>
                    </div>
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-lg font-bold text-black whitespace-nowrap">Our Civil Litigation Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            @php
                                $Services = [
                                    ...
                                    'General civil claims in Magistrates’ and High Courts'
                                ]
                            @endphp
                            @foreach($Services as $service)
                    ...
                    <div class="mt-12 max-w-4xl" data-aos="fade-up" data-aos-delay="400">
                        <p class="text-gray-700 leading-relaxed text-base">
                            At <strong>Sehunane Attorneys Inc</strong>, we are dedicated to resolving civil disputes efficiently while safeguarding your legal and financial interests. We offer practical advice and dependable representation to help you achieve fair and effective outcomes.
                        </p>
                    </div>
                </div>
            </main>
