@extends('layouts.app')
@section('title', 'Expert Property & Conveyancing Services | Sehunane Attorneys Inc') 
@section('meta_description', 'Specialized property and conveyancing representation in Kempton Park. We handle real estate transactions, property transfers, and conveyancing matters with professional excellence.')
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-8">Property and Conveyancing</h2>
                    <div class="space-y-6 text-gray-700 leading-relaxed text-base">
                        <p>
                            Property and conveyancing law deals with the legal transfer of property ownership and related property transactions. These processes must comply with strict legal requirements and regulatory procedures.
                        </p>
                        <p> 
                            At Sehunane Attorneys Inc, we understand that buying or selling property is often a significant financial decision. Our role is to ensure that the transaction is handled smoothly, efficiently, and in full compliance with the law.
                        </p>
                        <p>
                            We guide our clients through every step of the property transfer process, providing clarity and peace of mind.
                        </p>
                    </div>
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-lg font-bold text-black whitespace-nowrap">Our Third Party Claims Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            @php
                                $servicesList = [
                                    ...
                                    'General property-related legal advice'
                                ];
                            @endphp
                    ...
                    <div class="mt-12 max-w-4xl" data-aos="fade-up" data-aos-delay="400">
                        <p class="text-gray-700 leading-relaxed text-base">
                            At <strong>Sehunane Attorneys Inc</strong>, we are committed to ensuring that every property transaction is handled with care, accuracy, and efficiency. We guide our clients through each step of the process to provide clarity, compliance, and peace of mind.
                        </p>
                    </div>
                </div>
            </main>
