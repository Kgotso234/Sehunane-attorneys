...
@section('title', 'Expert Labour Law Services | Sehunane Attorneys Inc')
@section('meta_description', 'Specialized labour law representation in Kempton Park. We handle CCMA cases, unfair dismissals, and workplace disputes with professional excellence.')
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-black mb-8">Labour Law</h2>
                    ...
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-lg font-bold text-black whitespace-nowrap">Our Labour Law Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            ...
                            @foreach($labourServices as $service)
