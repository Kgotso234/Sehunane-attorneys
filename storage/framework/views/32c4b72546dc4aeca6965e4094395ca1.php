...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('images/sehunane_logo.png')); ?>">
    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', 'Sehunane Attorneys Inc'); ?>">

    <link rel="icon" href="<?php echo e(asset('images/sehunane_logo.png')); ?>">
    ...
    <script type="application/ld+json">
        {
          ...
          "url": "<?php echo e(url('/')); ?>",
          "logo": "<?php echo e(asset('images/sehunane_logo.png')); ?>",
          "address": {
            "@type": "PostalAddress",
