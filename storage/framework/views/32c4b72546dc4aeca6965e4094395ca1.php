...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Alegreya+Sans:ital,wght@0,100;0,300;0,400;0,500;0,700;0,800;0,900;1,100;1,300;1,400;1,500;1,700;1,800;1,900&family=Commissioner:wght@100..900&family=Cormorant+Upright:wght@300;400;500;600;700&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">

    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css']); ?>
    
    
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/app-sqKvUfiY.css')); ?>">
    
    <script type="module" src="<?php echo e(asset('build/assets/app-CvgioS1y.js')); ?>"></script>
...
<?php /**PATH /home/sehunac9n8g7/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>