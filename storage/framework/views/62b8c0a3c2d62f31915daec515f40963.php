<?php $__env->startSection('title', 'Expert Commercial Law Services | Sehunane Attorneys Inc'); ?>
...
<div class="min-h-screen bg-[#fcfcfc]">
    ...
    <section class="relative h-[350px] flex items-center overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white leading-tight" data-aos="fade-right">
                Commercial <span class="text-[#bb942f]">Law</span>
            </h1>
        </div>
    </section>
                ...
                <div class="prose prose-slate max-w-none">
                    <div class="mb-12" data-aos="fade-up">
                        ...
                        <div class="space-y-6 text-slate-600 text-lg leading-relaxed">
                            <p>
                                Commercial law regulates business transactions and corporate relationships. At <strong>Sehunane Attorneys Inc</strong>, we understand that businesses require practical legal solutions that support growth and protect commercial interests.
                            </p>
                            <p>
                    ...
                    <div class="mt-16 bg-white p-8 md:p-12 rounded-3xl border border-slate-100 shadow-sm" data-aos="fade-up">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <?php
                                $offerings = [
                                    ['title' => 'Contract Law', 'desc' => 'Drafting and reviewing precise commercial contracts.'],
                                    ['title' => 'Dispute Resolution', 'desc' => 'Resolving business conflicts with strategic litigation.'],
                                    ['title' => 'Compliance', 'desc' => 'Ensuring your business meets all regulatory standards.'],
                                    ['title' => 'Corporate Structure', 'desc' => 'Partnership and shareholder agreement management.'],
                                ];
                            ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\public_html\resources\views/pages/services/commercial.blade.php ENDPATH**/ ?>