...
<?php $__env->startSection('content'); ?>
    ...
    <div id="page-skeleton">
        <?php echo $__env->make('skeletons.contact', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
                    ...
                    <div class="max-w-7xl max-lg:max-w-3xl mx-auto p-4 md:p-8">
                        <div class="grid lg:grid-cols-2 gap-8 items-start">
                            <div class="bg-gray-50 rounded-lg p-8 border border-gray-200">
                                ...
                                <div class="space-y-6">
                                    <form id="contactForm" action="<?php echo e(route('contact.send')); ?>" method="POST" class="space-y-4">
                                        <?php echo csrf_field(); ?>
