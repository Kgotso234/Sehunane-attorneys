                                ...
                                <form id="contactForm" action="<?php echo e(route('contact.send')); ?>" method="POST">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-2 gap-4">
                                        ...
                                        <button
                                            ...
                                            class="w-full flex items-center justify-center gap-2 text-sm bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors border-0 cursor-pointer"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
