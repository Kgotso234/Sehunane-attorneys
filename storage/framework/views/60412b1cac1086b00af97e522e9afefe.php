                    ...
                    <div class="prose prose-slate max-w-none">
                        <div class="mb-12" data-aos="fade-up">
                            ...
                            <div class="space-y-6 text-slate-600 text-lg leading-relaxed">
                                ...
                                <p>
                                    Our approach focuses on resolving disputes efficiently through clear legal advice and meticulous case preparation. Whether in the Magistrates’ or High Courts, we safeguard your legal and financial interests with unwavering dedication.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-16 bg-white p-8 md:p-12 rounded-3xl border border-slate-100 shadow-sm" data-aos="fade-up">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <?php
                                    $offerings = [
                                        ['title' => 'Contractual Disputes', 'desc' => 'Resolving conflicts arising from broken or contested agreements.'],
                                        ['title' => 'Debt Recovery', 'desc' => 'Efficient legal mechanisms to recover outstanding commercial and personal debts.'],
                                        ['title' => 'Damages Claims', 'desc' => 'Seeking fair financial compensation for losses or injuries sustained.'],
                                        ['title' => 'General Litigation', 'desc' => 'Expert representation in both the Magistrates’ and High Courts.'],
                                    ];
                                ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\public_html\resources\views/pages/services/litigation.blade.php ENDPATH**/ ?>