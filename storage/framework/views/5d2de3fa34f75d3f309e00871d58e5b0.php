...
<?php $__env->startSection('title', 'Civil Litigation Attorneys Kempton Park | Sehunane Attorneys Inc'); ?>
<?php $__env->startSection('meta_description', 'Professional civil litigation in Kempton Park. From High Court representation to debt recovery and breach of contract, we protect your rights in Gauteng.'); ?>

<?php $__env->startSection('content'); ?>
    <div id="page-skeleton">
        <?php echo $__env->make('skeletons.services', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <div id="page-content" class="hidden">
        <div class="min-h-screen bg-[#fcfcfc]">
            <section class="relative h-[350px] flex items-center overflow-hidden">
                <div class="absolute inset-0 z-0">
                    <img src="<?php echo e(asset('images/law-firm-1.jpg')); ?>" alt="Civil Litigation Services Kempton Park" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sehunane Att\resources\views/pages/services/litigation.blade.php ENDPATH**/ ?>