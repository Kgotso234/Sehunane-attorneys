...
<?php $__env->startSection('title', 'Meet Our Legal Team | Expert Attorneys in Kempton Park'); ?>
...
<div class="min-h-screen">
    ...
    <section class="relative h-[250px] flex items-center">
        <div class="absolute inset-0 overflow-hidden">
            <img src="<?php echo e(asset('images/law-firm-1.jpg')); ?>" alt="about-img" class="w-full h-full object-cover transition-transform duration-[5000ms] hover:scale-110" data-aos="zoom-out" data-aos-duration="2000">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
                        ...
                        <div class="relative h-[400px] md:h-auto overflow-hidden">
                            <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
                                 src="<?php echo e(asset('images/image_icon.svg')); ?>" alt="founder">
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="shadow-medium hover:shadow-strong transition-all duration-300 overflow-hidden rounded-2xl bg-[var(--primary-foreground)] group" 
                        ...
                        <div class="relative h-[500px] overflow-hidden">
                            <img src="<?php echo e(asset('images/image_icon.svg')); ?>" alt="Mohale Ernest Seunane" 
                    ...
                    <div class="shadow-medium hover:shadow-strong transition-all duration-300 overflow-hidden rounded-2xl bg-[var(--primary-foreground)] group" 
                        ...
                        <div class="relative h-[500px] overflow-hidden">
                            <img src="<?php echo e(asset('images/image_icon.svg')); ?>" alt="Rakhidi Seunane" 
                                 class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
                        </div>
                        <div class="p-8">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehunac9n8g7/public_html/resources/views/pages/team.blade.php ENDPATH**/ ?>