<header class="sticky top-0 z-50 shadow-md">
    ...
    <nav class="lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:-bottom-17 z-50 w-7xl">
        <div id="collapseMenu" class="max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50">
            ...
            <ul class="min-h-[90px] bg-[#212529] lg:flex lg:items-stretch lg:w-full
                    max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md z-50">
                ...
                <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li class="lg:flex-1 text-center lg:border-r lg:border-white/20 last:border-r-0 flex group relative">
                        ...
                        <?php if(isset($item['is_dropdown']) && $item['is_dropdown']): ?>

                            <button type="button" 
                                class="relative w-full px-8 py-5 flex items-center justify-center text-[15px] font-medium transition-all duration-500 overflow-hidden text-white max-lg:text-[#3d251e]
                            ...
                            <ul class="service-dropdown absolute left-0 top-full hidden lg:group-hover:block bg-[#212529] min-w-[240px] shadow-2xl border-t-2 border-[#b38b2d] z-50">
                                ...
                                <?php $__currentLoopData = [
                                    ...
                                    <li>
                                        ...
                                        class="text-white block px-6 py-3 border-b border-white/5 hover:bg-[#BB942F] text-sm transition-colors <?php echo e($subActive ? 'bg-[#BB942F]' : ''); ?>">
...
</script><?php /**PATH /home/sehunac9n8g7/public_html/public_html/resources/views/partials/navbar.blade.php ENDPATH**/ ?>