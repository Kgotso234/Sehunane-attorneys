                                    ...
                                    >
                                        <div class="p-6 flex flex-col h-full">
                                            <div class="mb-4 p-3 bg-[#bb942f] rounded-lg w-fit group-hover:bg-[#bb942f]/20 transition-colors">
                                                <i data-lucide="<?php echo e($service['icon']); ?>" class="h-8 w-8 text-black"></i>
                                            </div>
                                    
                                            <h3 class="text-xl font-semibold mb-3 text-black"><?php echo e($service['title']); ?></h3>
        ...
        <section class="py-20 bg-[#36251e]">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center" data-aos="zoom-in" data-aos-duration="800">
                    ...
                    <a href="<?php echo e(url('/contact')); ?>" class="bg-[#bb942f] hover:bg-[#bb942f]/90 text-[var(--accent-foreground)] font-semibold py-3 px-6 rounded-md">Get Started Today</a>
                </div>
