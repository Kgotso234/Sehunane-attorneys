...
<?php $__env->startSection('title', 'Expert Labour Law Services | Sehunane Attorneys Inc'); ?>
<?php $__env->startSection('meta_description', 'Specialized labour law representation in Kempton Park. We handle CCMA cases, unfair dismissals, and workplace disputes with professional excellence.'); ?>
        ...
        <section class="relative h-[250px] flex items-center">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <nav class="flex items-center justify-center space-x-2 text-sm md:text-base mb-6">
                    ...
                    <span class="text-white font-bold">Labour Law</span>
                </nav>
                <h1 class="text-center text-3xl md:text-5xl font-bold text-white mb-4" data-aos="fade-up" data-aos-duration="1000">
                    Labour Law Services
                </h1>
                <!--<p class="text-center text-[var(--primary-foreground)] text-lg max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">-->
                <!--    Expert representation in workplace disputes, CCMA cases, and employment law matters-->
                <!--</p>-->
            </div>
        </section>
        ...
        <div class="flex flex-col-reverse lg:flex-row min-h-screen ">
             ...
             <main class="flex-1 flex flex-col overflow-hidden p-8 lg:p-16">
                <div class="max-w-4xl" data-aos="fade-up" data-aos-duration="1000">
                    <h2 class="text-3xl md:text-4xl font-bold text-[var(--primary)] mb-8">Labour Law</h2>
                    
                    <div class="space-y-6 text-gray-700 leading-relaxed text-lg">
                        <p>
                            Labour law regulates the rights and obligations of both employers and employees in the workplace. It covers matters such as unfair dismissal, disciplinary procedures, workplace disputes, CCMA proceedings, employment contracts, and compliance with labour legislation.
                        </p>
                        <p>
                            At Sehunane Attorneys Inc, we understand that workplace disputes can be stressful, disruptive, and emotionally taxing. Employment-related issues often affect not only your livelihood or business, but also your peace of mind. Our role is to guide you through these challenges with clear advice, practical solutions, and dependable legal representation.
                        </p>
                        <p>
                            We assist both employees and employers by providing strategic guidance that is legally sound and commercially realistic. Whether you are facing a dismissal dispute, preparing for a CCMA hearing, or seeking to ensure compliance with labour laws, our team is committed to protecting your rights and interests while working towards efficient and fair outcomes.
                        </p>
                    </div>
                    
                    <div class="mt-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-center gap-4 mb-8">
                            <h3 class="text-xl font-bold text-[var(--primary)] whitespace-nowrap">Our Labour Law Services Include</h3>
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            <?php
                                $labourServices = [
                                    ...
                                    'Employment contract drafting, review, and compliance advice',
                                    'Workplace disciplinary and grievance procedures',
                                    'Labour dispute resolution and negotiation',
                                    'Advice on employee rights and employer obligations',
                                    'Workplace harassment and discrimination matters'
                                ];
                            ?>
                    
                            <?php $__currentLoopData = $labourServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-start gap-4 text-gray-700 group">
                                    ...
                                    <span class="text-lg leading-tight"><?php echo e($service); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    ...
                    <div class="mt-16" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="mt-12 max-w-4xl" data-aos="fade-up" data-aos-delay="400">
                            <p class="text-gray-700 leading-relaxed text-lg">
                                At <strong>Sehunane Attorneys Inc</strong>, we are committed to providing clear guidance, practical solutions, and reliable representation in all labour law matters. Whether you are an employer or an employee, we are here to protect your rights and help you move forward with confidence.
                            </p>
                        </div>
                    </div>
                </div>
