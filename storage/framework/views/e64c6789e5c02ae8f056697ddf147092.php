        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-14 pt-4 pb-6 flex items-center justify-between">
            ...
            <div class="flex-shrink-0">
                <a href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('images/company_logo-removebg-preview (1).png')); ?>" 
                         alt="Logo" 
                         class="h-16 w-auto">
                </a>
            </div>
...
</script><?php /**PATH /home/sehunac9n8g7/public_html/resources/views/partials/navbar.blade.php ENDPATH**/ ?>