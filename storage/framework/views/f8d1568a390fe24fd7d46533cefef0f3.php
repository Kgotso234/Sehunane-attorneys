...
<?php $__env->startSection('title', 'Criminal Defense Attorney Kempton Park | Sehunane Attorneys Inc'); ?>
<?php $__env->startSection('meta_description', 'Arrested in Kempton Park? Get expert criminal defense for bail applications, trial representation, and expungements. 24/7 emergency legal assistance in Gauteng.'); ?>

<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-[#fcfcfc]">
        <section class="relative h-[350px] flex items-center overflow-hidden">
            <div class="absolute inset-0 z-0">
                <img src="<?php echo e(asset('images/law-firm-1.jpg')); ?>" alt="Criminal Defense Lawyer Kempton Park" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/sehunac9n8g7/public_html/resources/views/pages/services/criminal.blade.php ENDPATH**/ ?>