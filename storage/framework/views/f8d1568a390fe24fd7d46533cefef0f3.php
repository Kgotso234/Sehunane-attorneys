...
<?php $__env->startSection('title', 'Expert Criminal Law Services | Sehunane Attorneys Inc'); ?>
<?php $__env->startSection('meta_description', 'Specialized criminal law representation in Kempton Park. We handle criminal defense, prosecutions, and legal proceedings with professional excellence.'); ?>
        ...
        <section class="relative h-[250px] flex items-center">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <nav class="flex items-center justify-center space-x-2 text-sm md:text-base mb-6">
                    ...
                    <span class="text-white font-bold">Criminal Law</span>
                </nav>
