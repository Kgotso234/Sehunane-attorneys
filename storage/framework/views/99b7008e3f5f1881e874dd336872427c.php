...
<footer class="bg-[var(--primary)]/85 text-[var(--primary-foreground)] mt-20">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="space-y-4">
                <div class="flex items-center gap-2">
                    <img src="<?php echo e(asset('images/company_logo-removebg-preview (1).png')); ?>" alt="company logo"
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(url('/home')); ?>"    class="hover:text-[var(--accent)] transition-color">Home</a></li>
                    <li><a href="<?php echo e(url('/about')); ?>"   class="hover:text-[var(--accent)] transition-color">About Us</a></li>
                    <li><a href="<?php echo e(url('/services')); ?>"class="hover:text-[var(--accent)] transition-color">Our Services</a></li>
                    <li><a href="<?php echo e(url('/team')); ?>"    class="hover:text-[var(--accent)] transition-color">Our Team</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:info@schunaneattorneysinc.co.za" class="hover:text-[var(--accent)] transition-colors">
                            info@schunaneattorneysinc.co.za
                        </a>
                    </li>
                </ul>
            </div>
...
</footer><?php /**PATH /home/sehunac9n8g7/public_html/resources/views/partials/footer.blade.php ENDPATH**/ ?>